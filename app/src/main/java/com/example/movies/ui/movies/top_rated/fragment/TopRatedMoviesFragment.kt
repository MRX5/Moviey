package com.example.movies.ui.movies.top_rated.fragment
...
import com.example.movies.ui.movies.top_rated.viewModel.TopRatedViewModel
...
@AndroidEntryPoint
class TopRatedMoviesFragment : Fragment(),MediaClickListener {
